/**
 * Codes disposant d'un fichier dans `public/flags/`.
 *
 * Généré depuis le contenu du dossier. Sans cette liste, un code ISO
 * valide mais absent afficherait une image cassée : on préfère retomber
 * sur le globe neutre.
 */
